...
## Descripción
Backend completo para plataforma de e-commerce desarrollado en **Spring Boot 3** con arquitectura en capas y mejores prácticas de seguridad.
...
## Próximas Características (Post-TP)
